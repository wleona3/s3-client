...
use Keek\S3\Connector\Exception\CannotDeleteFile;
use Keek\S3\Connector\Exception\CannotGetBucket;
use Keek\S3\Connector\Exception\CannotGetFile;
use Keek\S3\Connector\Exception\CannotListBuckets;
use Keek\S3\Connector\Exception\CannotOpenFileForWrite;
use Keek\S3\Connector\Exception\CannotPutFile;
use Keek\S3\Connector\Response\Error;
